import chapterText from "./The Enemy Who Elevates.txt?raw";
...
function EnemyWhoElevates({ user, onBack, onSignOut, onNextChapter }) {
  return (
    <ChapterReader
      user={user}
      onBack={onBack}
      ...
      nextChapterLabel="THE TRIAL OF THE TRUE FRIEND"
      chapterText={chapterText}
      chapterTitle="THE ENEMY WHO ELEVATES"
      chapterNumber={6}
      bookLabel="Book 2"
...
export default EnemyWhoElevates;
