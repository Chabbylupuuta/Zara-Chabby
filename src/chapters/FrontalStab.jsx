import chapterText from "./The Frontal Stab (A Lesson in Friendship).txt?raw";
...
function FrontalStab({ user, onBack, onSignOut, onNextChapter }) {
  return (
    <ChapterReader
      user={user}
      onBack={onBack}
      ...
      nextChapterLabel="THE MARKET OF EMPTY PRAISE"
      chapterText={chapterText}
      chapterTitle="THE FRONTAL STAB (A LESSON IN FRIENDSHIP)"
      chapterNumber={1}
      bookLabel="Book 2"
